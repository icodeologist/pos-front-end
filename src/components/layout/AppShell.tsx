...
const links:{label:string;path:string;icon:IconName}[]=[
  {label:"Overview",path:"/",icon:"grid"},{label:"Point of Sale",path:"/billing",icon:"cart"},{label:"Products",path:"/products",icon:"box"},{label:"Customers",path:"/customer/register",icon:"users"},{label:"Credit System",path:"/credit",icon:"credit"},{label:"Reports",path:"/reports",icon:"chart"}
];
